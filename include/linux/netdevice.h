...
static inline bool net_gso_ok(u32 features, int gso_type)
{
	u32 feature = gso_type << NETIF_F_GSO_SHIFT;
...
static inline bool skb_gso_ok(struct sk_buff *skb, u32 features)
{
