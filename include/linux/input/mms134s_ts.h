...
struct mms_ts_platform_data {
	...
	const char	*fw_name_ums_0a;
	const char	*fw_name_ums_0f;
	const char	*fw_name_ums_47;
	const char	*fw_name_builtin_0a;
	const char	*fw_name_builtin_0f;
	const char	*fw_name_builtin_47;
